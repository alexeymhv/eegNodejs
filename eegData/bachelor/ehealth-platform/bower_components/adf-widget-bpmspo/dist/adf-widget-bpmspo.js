...
$templateCache.put("{widgetsPath}/bpmspo/src/view.html","<div><h1>Pulse Oximeter</h1><div ng-controller=bpmController><h3>Pulse: {{bpm.pulse}}</h3><h3>SPO2: {{bpm.spo2}}</h3></div></div>");}]);})(window);